...
def test_bad_pixel_type(amp_phs):
    ...
    with pytest.raises(TypeError):
        sicd_pixel_type.sicd_as_re32f_im32f(
            np.zeros(complex_array.shape, dtype=np.complex64), good_xml
        )
    with pytest.raises(TypeError):
        sicd_pixel_type.sicd_as_re16i_im16i(
            np.zeros(complex_array.shape, dtype=np.complex64), good_xml
        )
    with pytest.raises(TypeError):
        sicd_pixel_type.sicd_as_amp8i_phs8i(
...
def test_pixel_type(amp_phs):
    ...
    f32_arr, f32_xml = sicd_pixel_type.sicd_as_re32f_im32f(complex_array, good_xml)
    ...
    f32_arr_0, f32_xml_0 = sicd_pixel_type.sicd_as_re32f_im32f(
    ...
    i16_arr, i16_xml = sicd_pixel_type.sicd_as_re16i_im16i(complex_array, good_xml)
    ...
    i16_arr_2, i16_xml_2 = sicd_pixel_type.sicd_as_re16i_im16i(f32_arr, f32_xml)
    ...
    i8_arr, i8_xml = sicd_pixel_type.sicd_as_amp8i_phs8i(
    ...
    f32_arr2, f32_xml2 = sicd_pixel_type.sicd_as_re32f_im32f(i16_arr, i16_xml)
    ...
    i8_arr_2, i8_xml_2 = sicd_pixel_type.sicd_as_amp8i_phs8i(
